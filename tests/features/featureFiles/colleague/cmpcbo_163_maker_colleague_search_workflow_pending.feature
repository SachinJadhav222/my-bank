@cmpcbo-163 @client @workflow @createClientMVP @regression @sprint11
Feature: CMPCBO-163 - Maker Colleague search workflow in pending status
  ...
  status on check and confirm page with the displayed workflow id, only the back to search button is visible.
    Given I navigate to the "pending_maker_MVP" page
    ...
    Examples:
      ...
      | Create a new client   | Pending | 5063077318  |
