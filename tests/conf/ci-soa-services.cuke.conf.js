...
const getEndPoint = require('../endpoints_&_urls/soaEndpoints');
let featureFilePath;
...
if (argv.ff) {
    ...
    featureFilePath = 'tests/features/featureFiles/soa-services/' + argv.ff + '.feature';
}
else {
    //featureFilePath = 'tests/features/featureFiles/colleague/';
    featureFilePath = 'tests/features/featureFiles/soa-services/';
}

exports.config = {

    soaEndpoints: getEndPoint.getSoaEndPoint('non-ci'),
